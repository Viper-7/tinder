	...
	def cacheNZB(outLink)
		begin
			timeout(30) do
				...
				nzb = Net::HTTP.get_with_headers(outLink, {'User-Agent' => 'Mozilla/5.0 (Macintosh; U; PPC Mac OS X; en-us) AppleWebKit/523.10.6 (KHTML, like Gecko) Version/3.0.4 Safari/523.10.6'}).read
