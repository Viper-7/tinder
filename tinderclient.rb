...
class TinderChannel < TinderClientBase
	...
	sendChannel 'Fuck my ' + vagoo.first.downcase + ' ' + nick.downcase + ' you ' + dirty.first + ' ' + whore.first + '.'
    end
